...
def pad_sents_char(sents, char_pad_token):
    ...
    for s in sents:
        padded = []
        for word in s:
            padded_char_list = [char_pad_token]*max_word_length
            if len(word)<=max_word_length:
                padded_char_list[:len(word)] = word
            else:
                padded_char_list = word[:max_word_length]
            padded.append(padded_char_list)
        padded = padded + pad_token*(max_length-len(s))
