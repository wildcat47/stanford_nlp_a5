...
class VocabEntry(object):
    ...
    def words2charindices(self, sents):
        ...
        # sents = [[self.start_of_word+word+self.end_of_word for word in sent] for sent in sents]
        word_ids = [[[self.char2id[char] for char in word] for word in sent] for sent in sents]
        word_ids = [[[self.start_of_word]+word_chars+[self.end_of_word] for word_chars in sent] for sent in word_ids]
